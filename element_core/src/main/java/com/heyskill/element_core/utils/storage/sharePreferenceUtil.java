package com.heyskill.element_core.utils.storage;
...
public class sharePreferenceUtil {
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences((Context) ConfigGet.getConfiguration(ConfigFlag.APPLICATION_CONTEXT));
